...
function (_React$Component) {
  ...
  _proto.renderItem = function renderItem(list, _ref2) {
    ...
    if ((0, _isUndefined2.default)(label) && !item.group) {
    ...
    } else if ((0, _isUndefined2.default)(value) && !(0, _isUndefined2.default)(item.group)) {
    ...
    var focus = !(0, _isUndefined2.default)(focusItemValue) && (0, _utils.shallowEqual)(focusItemValue, value);
